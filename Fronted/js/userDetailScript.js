document.addEventListener('DOMContentLoaded', function () {
    ...
    // URLs del API
    const apiUrlADDEmployee = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=EMPLOYEE.ADD';
    const apiUrlGetEmployees = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=EMPLOYEE.FIND_ALL';
    const apiUrlDeleteEmployee = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=EMPLOYEE.DELETE';
    const apiUrlUpdateEmployee = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=EMPLOYEE.UPDATE';
    const apiUrlGetJobs = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=JOB.FIND_ALL';
    const apiUrlGetEstablishments = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=ESTABLISHMENT.FIND_ALL';
    const apiUrlADDProduct = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=PRODUCT.ADD';
    const apiUrlGetProducts = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=PRODUCT.FIND_ALL';
    const apiUrlUpdateProduct = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=PRODUCT.UPDATE';
    const apiUrlDeleteProduct = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=PRODUCT.DELETE';
    const apiUrlGetCategories = 'http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=CATEGORY.FIND_ALL';
    ...
    async function loadUserOrders() {
        ...
        try {
            const response = await fetch('http://52.44.178.183:8080/PruebaDBConsola/Controller?ACTION=ORDER.FIND_ALL');
